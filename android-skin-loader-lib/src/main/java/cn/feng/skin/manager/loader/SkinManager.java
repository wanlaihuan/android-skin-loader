...
public class SkinManager implements ISkinLoader {
    ...
    private List<SkinInflaterFactory> skinObservers;
        ...
        application.registerActivityLifecycleCallbacks(new Application.ActivityLifecycleCallbacks() {
            ...
            public void onActivityCreated(Activity activity, Bundle savedInstanceState) {
                if (activity instanceof FragmentActivity) {
                    try {
                        ...
                        activity.getLayoutInflater().setFactory(skinInflaterFactory);
            ...
            public void onActivityResumed(Activity activity) {
                if (skinInflaterFactory != null) {
                    SkinManager.getInstance().attach(skinInflaterFactory);
                }
            }
            ...
            public void onActivityDestroyed(Activity activity) {
                if (skinInflaterFactory != null) {
                    SkinManager.getInstance().detach(skinInflaterFactory);
                }
            }
        });
    }
    ...
    @Override
    public void attach(SkinInflaterFactory observer) {
    ...
    @Override
    public void detach(SkinInflaterFactory observer) {
    ...
    public void notifySkinUpdate() {
        if (skinObservers == null) return;
        for (SkinInflaterFactory observer : skinObservers) {
            observer.applySkin();
        }
    }
